...
from model import Bert_Model,Config
...
def main(train_file, dev_file, target_dir,
    ...
    train_data = DataPrecessForSentence(bert_tokenizer, train_file,pred = False)
    train_loader = DataLoader(train_data, shuffle=True, batch_size=batch_size)
    print("\t* Loading validation data...")
    dev_data = DataPrecessForSentence(bert_tokenizer,dev_file, pred = False)
    dev_loader = DataLoader(dev_data, shuffle=True, batch_size=batch_size)
    # -------------------- Model definition ------------------- #
    print("\t* Building model...")
    config = Config()
    model = Bert_Model(config).to(device)
    ...
    # checkpoint = target_dir+'/best.pth.tar'
    if checkpoint:
...
if __name__ == "__main__":
    train_file_path = './data/only_title_ccf_pytorch.csv'
    val_file_path = './data/only_title_ccf_pytorch.csv'

    main(train_file_path, val_file_path, "./models")
