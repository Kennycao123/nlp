...
payload = {"text":"今年1月房企合同销售金额遭遇寒潮，但碧桂园控股（02007.HK）董事局主席杨国强对于国内经济形势以及房地产行业的走向，似乎有着积极的信念。\
...
t1 = time.time()
x = requests.post('http://127.0.0.1:20003/news', data=payload,headers = {'Content-type': 'application/json'})
# x = requests.post('http://10.8.204.89:20003/news', data=payload,headers = {'Content-type': 'application/json'})
